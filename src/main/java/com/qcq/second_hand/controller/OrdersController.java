...
//            @Parameter(description = "购买数量", required = false, example = "1")
...
//                return new response(400, "购买数量必须大于0", null);
//            }
//
//            // 限制交付方式长度
...
//
//            // 创建订单并更新商品状态
//            Orders order = ordersService.createOrder(productId, buyerId, deliveryMethod, buyerRemark, quantity);
//
//            if (order == null) {
